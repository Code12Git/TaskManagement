                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="pt-2">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="w-full cursor-pointer flex justify-center items-center py-3 px-4 bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-2 text-white font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 disabled:opacity-70 disabled:cursor-not-allowed"
                            >
                                {isLoading ? (
